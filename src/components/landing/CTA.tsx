...
export default function CTA({
  ...
  if (pathname === "/links" ){
   return (
    <>
      <Container className="border border-dashed dark:border-white/10 border-black/20 py-4 rounded-md ">
        <div className="sm:px-12 px-6 sm:flex sm:justify-between sm:items-center w-full flex-col">
          <div className="w-full sm:w-auto sm:mt-0 flex justify-center sm:justify-end">
            <div
